...
import (
	...
	"github.com/abishekmuthian/bonehealthtracker/src/lib/view/helpers"

	"github.com/abishekmuthian/bonehealthtracker/src/lib/resource"
)
...
// OwnedBy returns true if this user id owns this user.
func (u *User) OwnedBy(uid int64) bool {
	return uid == u.ID
}
