...
const (
	...
	UploadResource // Does not check ownership
	ConnectResource
	ShowResource
	UpdateResource
	DestroyResource
...
// Upload returns an error if this action is not authorised for this user
func Upload(r Resource, u User) error {
	return Do(UploadResource, r, u)
}

// Connect returns an error if this action is not authorised for this user
func Connect(r Resource, u User) error {
	return Do(ConnectResource, r, u)
}
